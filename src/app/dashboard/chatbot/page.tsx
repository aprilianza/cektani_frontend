      ...
      <div className="flex-1 flex flex-col bg-white/60 backdrop-blur-sm border-green-100 overflow-hidden">
        ...
        <div className="border-t border-green-100 bg-white/80 backdrop-blur-sm p-6 flex-shrink-0">
          ...
          <div className="flex gap-2 mt-3">
            <button onClick={() => setInputMessage('Bagaimana cara menanam tanaman di daerah gersang?')} className="px-3 py-1.5 text-xs bg-green-100 text-green-700 rounded-full hover:bg-green-200 transition-colors">
